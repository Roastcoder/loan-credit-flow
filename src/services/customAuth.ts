...
export const customAuth = {
  signUp: async (mobile: string, mpin: string, name: string, employeeType: string, channelCode: string, pan: string, dob: string, aadhaar: string, aadhaarName: string, aadhaarAddress: string, aadhaarFatherName: string, aadhaarPhoto: string, email: string, bankAccount: string, ifsc: string, creditCardsAccess: boolean, loanDisbursementAccess: boolean) => {
